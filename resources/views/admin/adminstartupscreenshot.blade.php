				...
				@foreach($randomstartups as $randomstartup)
						...
						<div class="carousel-item active" data-mdb-interval="50000">
							<div class="display-short">
								<div class="startup-mainphoto w-50">
									<img src="{{ url('startup/'.$randomstartup->startupmainphoto) }}" class="d-block" height="500px" width="100%" alt="Startup Image"/>
								</div>
								<div class="startup-info w-50">
									...
									<div class="share-w-svg">
										...
										<img src="{{ url('startup-svg/'.$randomstartup->startupsvg) }}" class="svg"  alt="Startup related SVG"/>
									</div>
								</div>
							</div>
						</div>
					...
					@else
						<div class="carousel-item">
							<div class="display-short">
								<div class="startup-mainphoto w-50">
									<img src="{{ url('startup/'.$randomstartup->startupmainphoto) }}" class="d-block" height="500px" width="100%" loading="lazy" alt="Startup Image"/>
								</div>
								<div class="startup-info w-50">
									<div class="startup-name">{{$randomstartup->startupname}}</div>
									<div class="startup-about">
									...
									<div class="share-w-svg">
										...
										<img src="{{ url('startup-svg/'.$randomstartup->startupsvg) }}" class="svg" loading="lazy" alt="Startup related SVG"/>
									</div>
								</div>
							</div>
						</div>
