...
<html lang="en">
  ...
  <body>
   @include('top-navbar')  
    ...
    <div class="container-fluid col-md-6 profilepage_form">
        <div class="text-center homepage_meme">
            <div class="error_meme text-center">
                <img src="images/nopostfound.jpg" class="img-fluid" height="400" width="400" alt="" loading="lazy" />
            </div>
        </div>
    </div>
    ...
    $(document).ready(()=>{
        ...
        $('#file-input').change(function(){
            ...
            $('#filled-person').removeClass("bi bi-person-fill");
            $('#filled-person').addClass("bi bi-person");
        ...
        span.onclick = function() {
            ...
            $('#filled-person').removeClass("bi bi-person");
            $('#filled-person').addClass("bi bi-person-fill");
        }
    });
