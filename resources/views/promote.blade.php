...
<head>
    ...
    <meta property="og:title" content="Promote | ajourney.in" />

    <meta property="og:image" content="https://www.ajourney.in/web-images/aj.jpg" />

    <meta property="og:url" content="https://www.ajourney.in/promote" />
...
<body>
    ...
    <div class="container-fluid col-md-6">
        ...
        <div class="privacy-policy-image">
            ...
            <img class="img-fluid" src="{{url('web-images/maintenance.svg')}}">

        </div>

        <div class="notice">This page will be availabe soon</div>
