...
<html lang="en">
   <head>
      ...
      <link href="{{ url('css/google-fonts.css') }}" rel="stylesheet">
      <link href="{{ url('css/startup-1-hp.css') }}" rel="stylesheet">
   ...
   <body>
      ...
      <!--back-link--->
      <div class="bl">
         <a href="{{url('startup/search')}}" class="bi bi-arrow-left bl"> Back to search</a>
      </div>
      {{-- Lg-screen-share --}}
      ...
      <div class="container">
         ...
         <div class="back-link">
            <a href="{{url('startup/search')}}" class="bi bi-arrow-left ripple"></a>
         ...
         <div id="carouselDarkVariant" class="carousel slide carousel-fade carousel-dark" data-mdb-ride="carousel" >
            ...
            <div class="carousel-inner">
               ...
               <div class="carousel-item active" data-mdb-interval="2500">
                  <img src="{{ url('startup/'.$specificdetail->startupmainphoto) }}" height="400px" class="d-block w-100" alt="..." />
               ...
               <div class="carousel-item">
                  <img src="{{ url('startup/'.$specificdetail->startupfirstphoto) }}" height="400px" class="d-block w-100" alt="..." />
               </div>
               @endif
               @if($specificdetail->startupsecondphoto!="")
               <!-- Single item -->
               <div class="carousel-item">
                  <img src="{{ url('startup/'.$specificdetail->startupsecondphoto) }}" height="400px" class="d-block w-100" alt="..." />
               </div>
               @endif
               @if($specificdetail->startupthirdphoto!="")
               <!-- Single item -->
               <div class="carousel-item">
                  <img src="{{ url('startup/'.$specificdetail->startupthirdphoto) }}" height="400px" class="d-block w-100" alt="..." />
               </div>
               @endif
               @if($specificdetail->startupfourthphoto!="")
               <!-- Single item -->
               <div class="carousel-item">
                  <img src="{{ url('startup/'.$specificdetail->startupfourthphoto) }}" height="400px" class="d-block w-100" alt="..." />
               </div>
               @endif
            </div>
            ...
            <!-- Single item -->
            <div class="carousel-item">
               <img src="{{ url('startup/'.$specificdetail->startupfifthphoto) }}" height="400px" class="d-block w-100" alt="..." />
            </div>
            @endif
            <!-- Inner -->
            <!-- Controls -->
         ...
         <div class="all-information">
            <div class="wrapper-tag tagged">
               <ul>
                  <li>{{$specificdetail->startuptype}}</li>
               </ul>
            </div>
            <div class="indetails">
				...
				@endif
                               @if($specificdetail->amazonlink!="")
                                    <div class="youtube-link"><i class="fab fa-amazon" style="background-color: #000000;"></i> Amazon:<br>
                                        <a href="{{$specificdetail->amazonlink}}" target="_blank" class="dt-youtube">Click here to buy on Amazon</a>
                                    </div>
                                @endif
                        ...
                        <div class="startups-contact-us">
                           ...
                           <div class="startup-mail">
                              ...
                              <span style="color:#373838">{{$specificdetail->websitelink1}} <br>{{$specificdetail->websitelink2}}</span>
                              @else
